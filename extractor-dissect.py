...
def TOTAL_FEATURES(trace_data, max_size=175):
    ...
    ALL_FEATURES.append("PercIn")
    ALL_FEATURES.append(perc_in) # percentage of incoming packets
    ALL_FEATURES.append("PercOut")
    ALL_FEATURES.append(perc_out) # percentage of outgoing packets
    ALL_FEATURES.append("AltConc")
    ALL_FEATURES.extend(altconc) # 
    ALL_FEATURES.append("AltPerSec")
    ALL_FEATURES.extend(alt_per_sec) #
    ALL_FEATURES.append("SumAltConc")
    ALL_FEATURES.append(sum(altconc)) #
    ALL_FEATURES.append("SuAltPerSec")
    ALL_FEATURES.append(sum(alt_per_sec)) #
    ALL_FEATURES.append("SumInterTime")
    ALL_FEATURES.append(sum(intertimestats)) # sum of all max(In)
    ALL_FEATURES.append("SumTimeStat")
    ALL_FEATURES.append(sum(timestats)) # sum of all percentiles for In, Out, and Total
    ALL_FEATURES.append("SumNumPack")
    ALL_FEATURES.append(sum(number_pkts)) # sum of all the number of packets for In, Out, and Total, should be 2 * Total    ALL_FEATURES.append("-26")
